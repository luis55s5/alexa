...
while True:
    ...
    if status:
        ...
        elif 'bien y tu' in rec:
            speak('me da mucho gusto. yo estoy bien, si tu estas bien, que tengas un bonito dia')
            
        elif 'quien te creo' in rec:
            speak ('me crearon dos ingenieros de la upa, en su estadia, como progrmador, luis sabino moran y en mi diseño bleydy uribe')
